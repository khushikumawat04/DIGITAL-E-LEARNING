...
export default function Bio() {
  ...
  // ============ slider start =============
  const slides = [
    { img: "./images/Biology-slide1.png", content: "Content for Slide 1" },
    { img: "./images/Biology-slide2.png", content: "Content for Slide 2" },
    { img: "./images/Biology-slide3.png", content: "Content for Slide 3" }
  ];
      ...
      <div className="container-blueprint">
        <div className="card-blueprint blueprint-popup" >
          ...
          <div className="card-blueprint-content">
           <a href='https://cbseacademic.nic.in/web_material/CurriculumMain25/SrSec/Biology_SrSec_2024-25.pdf'> <h2>MP BOARD BLUEPRINT</h2></a>
            <p>Biology Blueprint</p>
        ...
        <div className="card-blueprint" >
          ...
          <div className="card-blueprint-content">
            <a href='https://cbseacademic.nic.in/web_material/CurriculumMain25/SrSec/Biology_SrSec_2024-25.pdf'><h2>CBSE BOARD BLUEPRINT</h2></a>
            <p>Biology Blueprint</p>
          </div>
        </div>

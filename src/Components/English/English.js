...
import '../Mathematics/Maths.css'; // Same CSS reuse
...
export default function English() {
  ...
  const slides = [
    { img: "./images/English-slide1.png", content: "Instructions for Slide 1" },
    { img: "./images/English-slide2.png", content: "Instructions for Slide 2" },
    { img: "./images/English-slide3.png", content: "Instructions for Slide 3" }
  ];
  ...
  const [completedChapters, setCompletedChapters] = useState(() => {
    return JSON.parse(localStorage.getItem('completedEnglishChapters')) || {};
  });

  useEffect(() => {
    localStorage.setItem('completedEnglishChapters', JSON.stringify(completedChapters));
  }, [completedChapters]);
  ...
  const progressPercentage = (completedCount / EnglishData.length) * 100;
      ...
      <div className="container-blueprint">
        <div className="card-blueprint blueprint-popup"> 
          ...
          <div className="card-blueprint-content">
            ...
            <p>English Flamingo Blueprint</p>
          </div>
        </div>
        <div className="card-blueprint">
          <img src="./images/cbscboard.png" alt="CBSE Board" />
          <div className="card-blueprint-content">
            <a href='https://cbseacademic.nic.in/web_material/CurriculumMain25/SrSec/English_SrSec_2024-25.pdf'><h2>CBSE BOARD BLUEPRINT</h2></a>
            <p>English Flamingo Blueprint</p>
          </div>
        </div>
      </div>
        ...
        <table>
            ...
            <tr>
              <th>
                <div className="progress-container">
                  ...
                  <p style={{ marginTop: "20px" }}>{completedCount}/{EnglishData.length} chapters completed</p>
                </div>
              </th>
              <th>S no.</th>
              <th>Chapters</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Total</td>
              <td></td>
              <td className="table-Total">{EnglishData.length * 5 /* or any total number */}</td>
